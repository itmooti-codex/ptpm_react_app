...
import { useRelatedRecordsData } from "../../inquiry-details/shared/useRelatedRecordsData.js";
import {
  toText,
  fullName,
  joinAddress,
...
export function JobDetailsScreen() {
  ...
  const {
    ...
    safeUid,
    setResolvedJobId,
  } = useJobDetailsRouteContext({ location, uid });
...
<div style="text-align:center;margin-top:16px"><button onclick="window.print()" style="padding:8px 20px;font-size:12px;cursor:pointer;background:#003882;color:#fff;border:none;border-radius:4px">Print / Save as PDF</button></div>
  ...
  return (
    <main className="min-h-screen w-full bg-slate-50 font-['Inter']" data-page="job-details">
      <GlobalTopHeader />
      <JobDetailsHeaderBar
        activeEmailGroup={activeEmailGroup}
        effectiveJobId={effectiveJobId}
        emailOptionsData={EMAIL_OPTIONS_DATA}
        externalJobUrl={externalJobUrl}
        handleConfirmJobTakenBy={handleConfirmJobTakenBy}
        handleConfirmServiceProviderAllocation={handleConfirmServiceProviderAllocation}
        handleCopyUid={handleCopyUid}
        handleCreateCallback={handleCreateCallback}
        handleDuplicateJob={handleDuplicateJob}
        handleEmailJob={handleEmailJob}
        handleMarkCompleteClick={handleMarkCompleteClick}
        handleOpenTasksModal={handleOpenTasksModal}
        handlePcaDoneToggle={handlePcaDoneToggle}
        handlePrestartDoneToggle={handlePrestartDoneToggle}
        handlePrintJobSheet={handlePrintJobSheet}
        handleRecordEmailAction={handleRecordEmailAction}
        hasQuoteAcceptedDateValue={hasQuoteAcceptedDateValue}
        hasRelatedInquiry={hasRelatedInquiry}
        isAllocatingServiceProvider={isAllocatingServiceProvider}
        isCreatingCallback={isCreatingCallback}
        isDuplicatingJob={isDuplicatingJob}
        isJobTakenByLookupLoading={isJobTakenByLookupLoading}
        isMarkComplete={isMarkComplete}
        isNewJob={isNewJob}
        isPcaDone={isPcaDone}
        isPrestartDone={isPrestartDone}
        isRecordingEmailAction={isRecordingEmailAction}
        isSavingJobTakenBy={isSavingJobTakenBy}
        isSavingPcaDone={isSavingPcaDone}
        isSavingPrestartDone={isSavingPrestartDone}
        isSendingJobUpdate={isSendingJobUpdate}
        isServiceProviderLookupLoading={isServiceProviderLookupLoading}
        jobStatusLabel={jobStatusLabel}
        jobStatusStyle={jobStatusStyle}
        jobTakenByItems={jobTakenByItems}
        jobTakenBySearch={jobTakenBySearch}
        ...
        quoteStatusNormalized={quoteStatusNormalized}
        relatedInquiryId={relatedInquiryId}
        safeUid={safeUid}
        serviceProviderItems={serviceProviderItems}
        serviceProviderSearch={serviceProviderSearch}
        setActiveEmailGroup={setActiveEmailGroup}
        setJobTakenBySearch={setJobTakenBySearch}
        setOpenMenu={setOpenMenu}
        setSelectedJobTakenById={setSelectedJobTakenById}
        setSelectedServiceProviderId={setSelectedServiceProviderId}
        setServiceProviderSearch={setServiceProviderSearch}
      ...
      <section className="w-full px-2 py-2" data-page="job-details">
        <div className="grid grid-cols-1 items-start gap-2 md:grid-cols-2 xl:grid-cols-3">
          ...
          <JobQuotePaymentDetailsCard
            effectiveJobId={effectiveJobId}
            hasAdminRecommendationValue={hasAdminRecommendationValue}
            hasAnyQuotePaymentDisplayField={hasAnyQuotePaymentDisplayField}
            hasFollowUpDateValue={hasFollowUpDateValue}
            hasPaymentStatusValue={hasPaymentStatusValue}
            hasPriorityValue={hasPriorityValue}
            hasQuoteAcceptedDateValue={hasQuoteAcceptedDateValue}
            hasQuoteDateValue={hasQuoteDateValue}
            hasQuoteRequestedDateValue={hasQuoteRequestedDateValue}
            hasQuoteSentDateValue={hasQuoteSentDateValue}
            hasQuoteStatusValue={hasQuoteStatusValue}
            hasQuoteValidUntilValue={hasQuoteValidUntilValue}
            isNewJob={isNewJob}
            paymentStatusLabel={paymentStatusLabel}
            paymentStatusStyle={paymentStatusStyle}
            priorityLabel={priorityLabel}
            priorityStyle={priorityStyle}
            quotePaymentDetails={quotePaymentDetails}
            quoteStatusLabel={quoteStatusLabel}
            quoteStatusStyle={quoteStatusStyle}
          />
        </div>

        <JobDetailsWorkspaceSection
          accountsContactItems={accountsContactItems}
          accountsContactSearchValue={accountsContactSearchValue}
          activeWorkspaceProperty={activeWorkspaceProperty}
          ...
          contactLogsContactId={contactLogsContactId}
          contactLogsError={contactLogsError}
          editingActivityId={editingActivityId}
          editingAppointmentId={editingAppointmentId}
          editingMaterialId={editingMaterialId}
          effectiveJobId={effectiveJobId}
          affiliationsError={affiliationsError}
          handleAcceptQuote={handleAcceptQuote}
          handleActivitySaved={handleActivitySaved}
          handleAddAccountsContact={handleAddAccountsContact}
          handleAddJobEmailContact={handleAddJobEmailContact}
          ...
          handleOpenCreateAppointmentModal={handleOpenCreateAppointmentModal}
          handleOpenCreateMaterialModal={handleOpenCreateMaterialModal}
          handleOpenEditActivityModal={handleOpenEditActivityModal}
          handleOpenEditAppointmentModal={handleOpenEditAppointmentModal}
          handleOpenEditMaterialModal={handleOpenEditMaterialModal}
          handleOpenUploadsModal={handleOpenUploadsModal}
          handleSelectWorkspacePropertyFromSearch={handleSelectWorkspacePropertyFromSearch}
          handleSelectWorkspacePropertyId={handleSelectWorkspacePropertyId}
          handleSendQuote={handleSendQuote}
          handleToggleRelatedInquiryLink={handleToggleRelatedInquiryLink}
          hasMemoContext={hasMemoContext}
          invoiceActiveTab={invoiceActiveTab}
          invoiceActiveTabVersion={invoiceActiveTabVersion}
          isActivityModalOpen={isActivityModalOpen}
          isAffiliationsLoading={isAffiliationsLoading}
          ...
          isContactLogsLoading={isContactLogsLoading}
          isLinkedPropertiesLoading={isLinkedPropertiesLoading}
          isMaterialModalOpen={isMaterialModalOpen}
          isMemosLoading={isMemosLoading}
          isQuoteWorkflowUpdating={isQuoteWorkflowUpdating}
          isSavingLinkedInquiry={isSavingLinkedInquiry}
          isUploadsModalOpen={isUploadsModalOpen}
          isWorkspaceSectionsLoading={isWorkspaceSectionsLoading}
          jobActivities={jobActivities}
          jobData={jobDirectBootstrapJobData}
          jobEmailContactSearchValue={jobEmailContactSearchValue}
          jobEmailItems={jobEmailItems}
          jobMaterials={jobMaterials}
          linkedPropertiesError={linkedPropertiesError}
          linkedWorkspaceProperties={linkedWorkspaceProperties}
          ...
          onAccountsContactSearchValueChange={setAccountsContactSearchValue}
          onActiveWorkspaceTabChange={setActiveWorkspaceTab}
          ...
          onJobEmailContactSearchValueChange={setJobEmailContactSearchValue}
          onNavigateToDeal={(nextUid) =>
            navigate(`/inquiry-details/${encodeURIComponent(nextUid)}`)
          }
          onNavigateToJob={(nextUid) => navigate(`/job-details/${encodeURIComponent(nextUid)}`)}
          onOpenContactDetailsModal={openContactDetailsModal}
          onOpenMemoReply={handleOpenMemoReply}
          onWorkspacePropertySearchValueChange={setWorkspacePropertySearchValue}
          plugin={plugin}
          propertyAffiliationModalState={affiliationModalState}
          quoteHeaderData={quoteHeaderData}
          relatedDealsForDisplay={relatedDealsForDisplay}
          relatedInquiryId={relatedInquiryId}
          relatedInquiryUid={relatedInquiryUid}
          relatedJobsForDisplay={relatedJobsForDisplay}
          ...
          searchWorkspacePropertiesInDatabase={searchWorkspacePropertiesInDatabase}
          selectedAccountsContactId={selectedAccountsContactId}
          selectedWorkspacePropertyId={selectedWorkspacePropertyId}
          setSelectedAccountsContactId={setSelectedAccountsContactId}
          setSelectedJobEmailContactId={setSelectedJobEmailContactId}
          uploadsPropertyId={uploadsPropertyId}
          workspacePropertyLookupError={workspacePropertyLookupError}
          workspacePropertySearchItems={workspacePropertySearchItems}
          workspacePropertySearchValue={workspacePropertySearchValue}
          workspaceSectionsError={workspaceSectionsError}
        />
      </section>
      ...
      <JobDetailsModalStack
        ...
        closeMarkCompleteConfirm={handleCloseMarkCompleteConfirm}
        closeTasksModal={handleCloseTasksModal}
        companyPopupComment={companyPopupComment}
        confirmDeleteMemoItem={confirmDeleteMemoItem}
        contactModalState={contactModalState}
        contactPopupComment={contactPopupComment}
        effectiveJobId={effectiveJobId}
        handleConfirmMarkComplete={handleConfirmMarkComplete}
        handleSavePopupComments={handleSavePopupComments}
        isAddPropertyOpen={isAddPropertyOpen}
        isDeletingMemoItem={isDeletingMemoItem}
        isMarkCompleteConfirmOpen={isMarkCompleteConfirmOpen}
        isPopupCommentModalOpen={isPopupCommentModalOpen}
        isSavingMarkComplete={isSavingMarkComplete}
        isSavingPopupComment={isSavingPopupComment}
        memoDeleteTarget={memoDeleteTarget}
        onCloseAddProperty={() => setIsAddPropertyOpen(false)}
        pendingMarkCompleteValue={pendingMarkCompleteValue}
        plugin={plugin}
        popupCommentDrafts={popupCommentDrafts}
        propertyModalMode={propertyModalMode}
        relatedInquiryId={relatedInquiryId}
        relatedInquiryRecord={relatedInquiryRecord}
        saveProperty={handleSaveProperty}
        setIsPopupCommentModalOpen={setIsPopupCommentModalOpen}
        setMemoDeleteTarget={setMemoDeleteTarget}
        setPopupCommentDrafts={setPopupCommentDrafts}
        showCompanyDetails={showCompanyDetails}
        showContactDetails={showContactDetails}
        tasksModalOpen={isTasksModalOpen}
      />

      <JobDetailsFloatingWidgets
        areFloatingWidgetsVisible={areFloatingWidgetsVisible}
        currentUserId={currentUserId}
        DeleteIcon={TrashIcon}
        focusMemoId={memoFocusRequest.memoId}
        focusRequestKey={memoFocusRequest.key}
        handleClearMemoFile={handleClearMemoFile}
        handleMemoFileChange={handleMemoFileChange}
        handleSendMemo={handleSendMemo}
        handleSendMemoReply={handleSendMemoReply}
        hasMemoContext={hasMemoContext}
        hasPopupCommentsSection={hasPopupCommentsSection}
        isMemoChatOpen={isMemoChatOpen}
        isMemosLoading={isMemosLoading}
        ...
        onCloseMemoChat={() => setIsMemoChatOpen(false)}
        onDeleteMemoItem={setMemoDeleteTarget}
        onMemoTextChange={setMemoText}
        onOpenPopupComments={() => {
          if (!hasPopupCommentsSection) return;
          setIsPopupCommentModalOpen(true);
        }}
        onToggleMemoChat={() => setIsMemoChatOpen((previous) => !previous)}
        onToggleWidgets={() => setAreFloatingWidgetsVisible((previous) => !previous)}
        resolveMemoAuthor={resolveMemoAuthor}
