...
export function JobDetailsFloatingWidgets({
  areFloatingWidgetsVisible = false,
  currentUserId = "",
  DeleteIcon,
  focusRequestKey = 0,
  focusMemoId = "",
  ...
  hasPopupCommentsSection = false,
  isMemoChatOpen = false,
