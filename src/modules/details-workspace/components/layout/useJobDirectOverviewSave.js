...
export function createOverviewDraftFromJob(job = {}) {
  return {
...
export function useJobDirectOverviewSave({ plugin, jobUid, activeJobData, onExternalUnsavedChange }) {
  ...
  useEffect(() => {
    ...
    setHasUnsavedChanges(false);
    if (typeof onExternalUnsavedChange === "function") {
      onExternalUnsavedChange(false);
    }
  }, [activeJobData, overviewDraft, storeActions, onExternalUnsavedChange]);
